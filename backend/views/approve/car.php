...
<div class="diamond-order-index box">
    <div class="box-header">
        ...
        <?= Html::a('审核通过', ['carpass'], ['class' => 'btn btn-primary']) ?>
    </div>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'view' => function ($url, $dataProvider, $key) {
                      return  Html::a('<span class="glyphicon glyphicon-eye-open"></span>', ['view', 'id' => $dataProvider->user_id, 'type'=>'car'] , ['title' => '查看'] );
                     },
