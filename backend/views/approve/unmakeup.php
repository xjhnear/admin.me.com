...
<div class="diamond-order-index box">
    <div class="box-header">
        ...
        <?= Html::a('审核通过', ['unmakeuppass'], ['class' => 'btn btn-primary']) ?>
    </div>
    <?= GridView::widget([
        ...
        'columns' => [
    		...
    		'attribute' => '素颜预览',
    		'value' => function($v) {
    		return pic($v, 'unmakeupCertification');
    		},
    		'format' => 'html'
    		],
            ...
            'view' => function ($url, $dataProvider, $key) {
                      return  Html::a('<span class="glyphicon glyphicon-eye-open"></span>', ['view', 'id' => $dataProvider->user_id, 'type'=>'unmakeup'] , ['title' => '查看'] );
                     },
