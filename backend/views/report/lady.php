...
<div class="user-index box">
	...
	<?= Tabs::widget([
	    'items' => [
	        [
	            'label' => '收益',
				'content' => $this->render('diamondhistorylady',['dataProvider'=>$dataDiamondhistory]),
	        ...
	        [
	            'label' => '提现',
				'content' => $this->render('withdraw',['dataProvider'=>$dataWithdraw]),
...
jQuery(".export").click(function(){
	window.location.pathname = '/report/exportlady?t=' + $('#reservation').val();
});
</script>
<script type="text/javascript">
