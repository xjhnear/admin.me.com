...
<div class="user-index box">
	...
	<?= Tabs::widget([
	    'items' => [
	        [
	            'label' => '收益',
				'content' => $this->render('profit',['dataProvider'=>$dataProfit]),
			...
			[
				'label' => '提现',
				'content' => $this->render('withdrawcom',['dataProvider'=>$dataWithdraw]),
...
jQuery(".export").click(function(){
	window.location = '/report/exportcom?t=' + $('#reservation').val();
});
</script>
<script type="text/javascript">
