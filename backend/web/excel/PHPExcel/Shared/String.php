...
class PHPExcel_Shared_String
{
	...
	private static function _buildSYLKCharacters()
	{
		self::$_SYLKCharacters = array(
			...
			"\x1B!?"  => chr(31),
			"\x1B'?"  => chr(127),
			"\x1B(0"  => 'EUR', // 128 in CP1252
			"\x1B(2"  => chr(39), // 130 in CP1252
			...
			"\x1B(:"  => 'S', // 138 in CP1252
			"\x1B(;"  => '<', // 139 in CP1252
			"\x1BNj"  => 'OE', // 140 in CP1252
			"\x1B(>"  => 'Z', // 142 in CP1252
			"\x1B)1"  => '‘', // 145 in CP1252
			"\x1B)2"  => '’', // 146 in CP1252
			"\x1B)3"  => '“', // 147 in CP1252
			"\x1B)4"  => '”', // 148 in CP1252
			"\x1B)5"  => 'o', // 149 in CP1252
			"\x1B)6"  => '–', // 150 in CP1252
			"\x1B)7"  => '—', // 151 in CP1252
			"\x1B)8"  => '~', // 152 in CP1252
			"\x1B)9"  => 'TM', // 153 in CP1252
			"\x1B):"  => 's', // 154 in CP1252
			"\x1B);"  => '>', // 155 in CP1252
			"\x1BNz"  => 'oe', // 156 in CP1252
			"\x1B)>"  => 'z', // 158 in CP1252
			"\x1B)?"  => '"Y', // 159 in CP1252
			"\x1B*0"  => ' ', // 160 in CP1252
			"\x1BN!"  => '!', // 161 in CP1252
			"\x1BN\"" => 'c', // 162 in CP1252
			"\x1BN#"  => 'lb', // 163 in CP1252
			"\x1BN("  => '¤', // 164 in CP1252
			"\x1BN%"  => 'yen', // 165 in CP1252
			"\x1B*6"  => '|', // 166 in CP1252
			"\x1BN'"  => '§', // 167 in CP1252
			"\x1BNH " => '¨', // 168 in CP1252
			"\x1BNS"  => '(c)', // 169 in CP1252
			"\x1BNc"  => 'a', // 170 in CP1252
			"\x1BN+"  => '<<', // 171 in CP1252
			"\x1B*<"  => 'not', // 172 in CP1252
			"\x1B*="  => '-', // 173 in CP1252
			"\x1BNR"  => '(R)', // 174 in CP1252
			"\x1B*?"  => '', // 175 in CP1252
			"\x1BN0"  => '°', // 176 in CP1252
			"\x1BN1"  => '±', // 177 in CP1252
			"\x1BN2"  => '^2', // 178 in CP1252
			"\x1BN3"  => '^3', // 179 in CP1252
			"\x1BNB " => chr(39), // 180 in CP1252
			"\x1BN5"  => 'u', // 181 in CP1252
			"\x1BN6"  => 'P', // 182 in CP1252
			"\x1BN7"  => '·', // 183 in CP1252
			"\x1B+8"  => ',', // 184 in CP1252
			"\x1BNQ"  => '^1', // 185 in CP1252
			"\x1BNk"  => 'o', // 186 in CP1252
			"\x1BN;"  => '>>', // 187 in CP1252
			"\x1BN<"  => ' 1/4 ', // 188 in CP1252
			"\x1BN="  => ' 1/2 ', // 189 in CP1252
			"\x1BN>"  => ' 3/4 ', // 190 in CP1252
			"\x1BN?"  => '?', // 191 in CP1252
			"\x1BNAA" => '`A', // 192 in CP1252
			"\x1BNBA" => chr(39).'A', // 193 in CP1252
			"\x1BNCA" => '^A', // 194 in CP1252
			"\x1BNDA" => '~A', // 195 in CP1252
			"\x1BNHA" => '"A', // 196 in CP1252
			"\x1BNJA" => 'A', // 197 in CP1252
			"\x1BNa"  => 'AE', // 198 in CP1252
			"\x1BNKC" => 'C', // 199 in CP1252
			"\x1BNAE" => '`E', // 200 in CP1252
			"\x1BNBE" => chr(39).'E', // 201 in CP1252
			"\x1BNCE" => '^E', // 202 in CP1252
			"\x1BNHE" => '"E', // 203 in CP1252
			"\x1BNAI" => '`I', // 204 in CP1252
			"\x1BNBI" => chr(39).'I', // 205 in CP1252
			"\x1BNCI" => '^I', // 206 in CP1252
			"\x1BNHI" => '"I', // 207 in CP1252
			"\x1BNb"  => 'D', // 208 in CP1252
			"\x1BNDN" => '~N', // 209 in CP1252
			"\x1BNAO" => '`O', // 210 in CP1252
			"\x1BNBO" => chr(39).'O', // 211 in CP1252
			"\x1BNCO" => '^O', // 212 in CP1252
			"\x1BNDO" => '~O', // 213 in CP1252
			"\x1BNHO" => '"O', // 214 in CP1252
			"\x1B-7"  => '×', // 215 in CP1252
			"\x1BNi"  => 'O', // 216 in CP1252
			"\x1BNAU" => '`U', // 217 in CP1252
			"\x1BNBU" => chr(39).'U', // 218 in CP1252
			"\x1BNCU" => '^U', // 219 in CP1252
			"\x1BNHU" => '"U', // 220 in CP1252
			"\x1B-="  => chr(39).'Y', // 221 in CP1252
			"\x1BNl"  => 'Th', // 222 in CP1252
			"\x1BN{"  => 'ss', // 223 in CP1252
			"\x1BNAa" => 'à', // 224 in CP1252
			"\x1BNBa" => 'á', // 225 in CP1252
			"\x1BNCa" => '^a', // 226 in CP1252
			"\x1BNDa" => '~a', // 227 in CP1252
			"\x1BNHa" => '"a', // 228 in CP1252
			"\x1BNJa" => 'a', // 229 in CP1252
			"\x1BNq"  => 'ae', // 230 in CP1252
			"\x1BNKc" => 'c', // 231 in CP1252
			"\x1BNAe" => 'è', // 232 in CP1252
			"\x1BNBe" => 'é', // 233 in CP1252
			"\x1BNCe" => 'ê', // 234 in CP1252
			"\x1BNHe" => '"e', // 235 in CP1252
			"\x1BNAi" => 'ì', // 236 in CP1252
			"\x1BNBi" => 'í', // 237 in CP1252
			"\x1BNCi" => '^i', // 238 in CP1252
			"\x1BNHi" => '"i', // 239 in CP1252
			"\x1BNs"  => 'd', // 240 in CP1252
			"\x1BNDn" => '~n', // 241 in CP1252
			"\x1BNAo" => 'ò', // 242 in CP1252
			"\x1BNBo" => 'ó', // 243 in CP1252
			"\x1BNCo" => '^o', // 244 in CP1252
			"\x1BNDo" => '~o', // 245 in CP1252
			"\x1BNHo" => '"o', // 246 in CP1252
			"\x1B/7"  => '÷', // 247 in CP1252
			"\x1BNy"  => 'o', // 248 in CP1252
			"\x1BNAu" => 'ù', // 249 in CP1252
			"\x1BNBu" => 'ú', // 250 in CP1252
			"\x1BNCu" => '^u', // 251 in CP1252
			"\x1BNHu" => 'ü', // 252 in CP1252
			"\x1B/="  => chr(39).'y', // 253 in CP1252
			"\x1BN|"  => 'th', // 254 in CP1252
			"\x1BNHy" => '"y', // 255 in CP1252
		);
	}
